<?php
    ...
    class VeiculoDAO
    {
        ...
        {
            $qInserir = "INSERT INTO veiculo(modelo,marca,ano,placa) VALUES (:modelo,:marca,:ano,:placa)";            
        ...
        {
            $qAtualizar = "UPDATE veiculo SET modelo=:modelo, marca=:marca, ano=:ano, placa=:placa WHERE id=:id";            
            $pdo = PDOFactory::getConexao();
